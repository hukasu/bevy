...
use bevy_render::{
    ...
    render_resource::{
        ...
        BindlessSlabResourceLimit, RenderPipelineDescriptor, ShaderRef,
...
impl_type_path!((in bevy_render_3d::extended_material) ExtendedMaterial<B: Material, E: MaterialExtension>);
