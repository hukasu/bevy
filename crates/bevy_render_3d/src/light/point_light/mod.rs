...
use crate::{cluster::plugin::ClusterAssignable, volumetric_fog::VolumetricLight};

use super::LightVisibilityClass;
...
impl ClusterAssignable for PointLight {
    type Query<'a> = (
        Entity,
        &'a GlobalTransform,
        &'a PointLight,
    ...
    fn transform(
        ...
        GlobalTransform::from_translation(query_data.1.translation())
    }
