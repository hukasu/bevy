...
use super::plugin::{CUBE_MESH, PLANE_MESH, VOLUMETRIC_FOG_HANDLE};
...
impl VolumetricFogBindGroupLayoutKey {
    ...
    /// these flags.
    pub fn bind_group_layout_description(&self) -> String {
        if self.is_empty() {
...
impl FromWorld for VolumetricFogPipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let bind_group_layouts = core::array::from_fn(|bits| {
