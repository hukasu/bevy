...
use crate::{
    ...
    volumetric_fog::{
        render::{VolumetricFogPipeline, VolumetricFogUniformBuffer},
        FogVolume, VolumetricFog, VolumetricLight,
    },
};

use super::render::VolumetricFogNode;

/// The volumetric fog shader.
pub(super) const VOLUMETRIC_FOG_HANDLE: Handle<Shader> =
...
pub(super) const PLANE_MESH: Handle<Mesh> = weak_handle!("92523617-c708-4fd0-b42f-ceb4300c930b");
...
pub(super) const CUBE_MESH: Handle<Mesh> = weak_handle!("4a1dd661-2d91-4377-a17a-a914e21e277e");
...
impl Plugin for VolumetricFogPlugin {
    fn build(&self, app: &mut App) {
        ...
        render_app
            ...
            .add_systems(ExtractSchedule, systems::extract_volumetric_fog)
            .add_systems(
                Render,
                (
                    systems::prepare_volumetric_fog_pipelines.in_set(RenderSet::Prepare),
                    systems::prepare_volumetric_fog_uniforms.in_set(RenderSet::Prepare),
                    systems::prepare_view_depth_textures_for_volumetric_fog
