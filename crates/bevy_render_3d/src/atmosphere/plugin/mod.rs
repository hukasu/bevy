...
use super::{
    atmosphere::{
        AtmosphereBindGroupLayouts, AtmosphereLutPipelines, AtmosphereLutsNode, AtmosphereNode,
        AtmosphereSamplers, AtmosphereTransforms,
    },
    sky::{RenderSkyBindGroupLayouts, RenderSkyNode},
};

const TYPES: Handle<Shader> = weak_handle!("ef7e147e-30a0-4513-bae3-ddde2a6c20c5");
const FUNCTIONS: Handle<Shader> = weak_handle!("7ff93872-2ee9-4598-9f88-68b02fef605f");
const BRUNETON_FUNCTIONS: Handle<Shader> = weak_handle!("e2dccbb0-7322-444a-983b-e74d0a08bcda");
const BINDINGS: Handle<Shader> = weak_handle!("bcc55ce5-0fc4-451e-8393-1b9efd2612c4");
pub(super) const TRANSMITTANCE_LUT: Handle<Shader> =
    weak_handle!("a4187282-8cb1-42d3-889c-cbbfb6044183");
pub(super) const MULTISCATTERING_LUT: Handle<Shader> =
    weak_handle!("bde3a71a-73e9-49fe-a379-a81940c67a1e");
pub(super) const SKY_VIEW_LUT: Handle<Shader> =
    weak_handle!("f87e007a-bf4b-4f99-9ef0-ac21d369f0e5");
pub(super) const AERIAL_VIEW_LUT: Handle<Shader> =
    weak_handle!("a3daf030-4b64-49ae-a6a7-354489597cbe");
pub(super) const RENDER_SKY: Handle<Shader> = weak_handle!("09422f46-d0f7-41c1-be24-121c17d6e834");
