...
use super::{
    uniforms::{skins_use_uniform_buffers, SkinUniformInfo, SkinUniforms},
    JOINTS_PER_ALLOCATION_UNIT, JOINT_EXTRACTION_THRESHOLD_FACTOR, MAX_JOINTS,
};
...
/// CPU staging buffer.
pub fn extract_joints_for_skin(
...
pub fn remove_skin(skin_uniforms: &mut SkinUniforms, skinned_mesh_entity: MainEntity) {
